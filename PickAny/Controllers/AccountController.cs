    ...
    public class AccountController : Controller
    {
        ...
        public string AccountManagerSetup()
        {
            try
            {
                ...
                if (!WebSecurity.UserExists("Administrator"))
                {
                    ...
                    WebSecurity.CreateUserAndAccount("Administrator", "@admin", new
                    {
        ...
        public string AccountSetup()
        {
            try
            {
                ...
                if (!WebSecurity.UserExists("Account"))
                {

                    WebSecurity.CreateUserAndAccount("Account", "@account", new
                    {
                    ...
                    Roles.AddUserToRole("Account", "Account");
                    return "Success";
                }
                return "false";
            }
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            TempData["fmsg"] = "The user name or password provided is incorrect.";
            return View(model);
        }
